...
class SerialSocket extends BluetoothGattCallback {
    ...
    private static final UUID BLUETOOTH_LE_YANG_SERVICE = UUID.fromString("0xffe0");
//    private static final UUID BLUETOOTH_LE_YANG_SERVICE = UUID.fromString("19B10000-E8F2-537E-4F6C-D104768A1214");
    private static final UUID BLUETOOTH_LE_CC254X_CHAR_RW = UUID.fromString("0000ffe1-0000-1000-8000-00805f9b34fb");

    private static final UUID BLUETOOTH_LE_YANG_CHAR_RW = UUID.fromString("0xffe1");
//    private static final UUID BLUETOOTH_LE_YANG_CHAR_RW = UUID.fromString("19B10001-E8F2-537E-4F6C-D104768A1214");
    ...
    private static final UUID BLUETOOTH_LE_MICROCHIP_BOWON     = UUID.fromString("0385ba5b-4acf-8564-36ac-08f7261a03e0");
    ...
    private void connectCharacteristics1(BluetoothGatt gatt) {
        ...
        for (BluetoothGattService gattService : gatt.getServices()) {
            ...
            if (gattService.getUuid().equals(BLUETOOTH_LE_YANG_SERVICE))
                delegate = new Cc245XDelegate();
...
//            readCharacteristic = gattService.getCharacteristic(BLUETOOTH_LE_YANG_CHAR_RW);
            writeCharacteristic = gattService.getCharacteristic(BLUETOOTH_LE_CC254X_CHAR_RW);
//            writeCharacteristic = gattService.getCharacteristic(BLUETOOTH_LE_YANG_CHAR_RW);
            return true;
        }
    }
